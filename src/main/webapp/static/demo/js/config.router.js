  ...
  .config(
    [          '$stateProvider', '$urlRouterProvider','angularShiroConfigProvider',
      function ($stateProvider,   $urlRouterProvider,config) {
          config.setFilter('/access/signin','anon');
          config.setFilter('/app/user/detail/*','perms[user:edit]');
          config.setFilter('/app/user/add','perms[user:add]');
          ...
          $stateProvider
              ...
              .state('app.servers.list',{
                  url:'/list',
                  templateUrl:'tpl/server-show.html',
                  controller: 'ShowServersController',
                  // use resolve to load other dependences
                  resolve: {
                      deps: ['uiLoad',
                          function( uiLoad ){
                              return uiLoad.load( ['js/controllers/server.js'] );
                          }]
                  }
              })
              .state('app.servers.detail',{
                  url:'/{server_id}',
              ...
              .state('app.customers.list',{
                  url:'/list',
                  templateUrl:'tpl/customer-show.html',
                  controller: 'ShowCustomersController',
                  // use resolve to load other dependences
                  resolve: {
                      deps: ['uiLoad',
                          function( uiLoad ){
                              return uiLoad.load( ['js/controllers/customer.js'] );
                          }]
                  }
              })
              .state('app.customers.detail',{
                  url:'/{customer_id}',
                  templateUrl:'tpl/customer-add.html',
