...
app.controller('ShowCustomersController', ["$scope", "CustomerService", function ($scope, CustomerService) {
...
app.controller('AddCustomerController', function ($scope, $location, $stateParams,CustomerService) {
